...
Q_DECLARE_METATYPE(nary::tree<char>);
...
void NaryTreeIterationTest::iteration() {
    ...
    copy(
        t.begin<breadth_first<nary::node<char>>>(),
        t.end<breadth_first<nary::node<char>>>(),
    ...
    copy(
        t.rbegin<breadth_first<nary::node<char>>>(),
        t.rend<breadth_first<nary::node<char>>>(),
...
void NaryTreeIterationTest::iteration_data() {
    QTest::addColumn<nary::tree<char>>("t");
