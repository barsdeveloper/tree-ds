...
void StructNodeTest::bigTree1() {
    ...
    QCOMPARE(tree.get_child(const_index<0>()).get_child(const_index<1>()).get_subtree_size(), 9);
    QCOMPARE(tree.get_child(const_index<0>()).get_child(const_index<1>()).get_subtree_arity(), 1);
    QCOMPARE(
    ...
    QCOMPARE(tree.get_child(const_index<0>()).get_child(const_index<7>()).get_subtree_size(), 4);
    QCOMPARE(tree.get_child(const_index<0>()).get_child(const_index<7>()).get_subtree_arity(), 3);
