...
void TreeViewIterationTest::iteration() {
    ...
    QFETCH(vector<int>, expectedLeaves);
    ...
    vector<int> actualBinaryLeaves(binary.begin(policy::leaves()), binary.end(policy::leaves()));
    ...
    vector<int> actualNaryLeaves(nary.begin(policy::leaves()), nary.end(policy::leaves()));
...
void TreeViewIterationTest::iteration_data() {
    ...
    QTest::addColumn<vector<int>>("expectedLeaves");
    ...
    QTest::newRow("Straight")
        ...
        << vector {12, 13, 14, 23, 16, 17, 18, 19};

    /******************************************************************************************************************/
    QTest::newRow("From begin (root)")
